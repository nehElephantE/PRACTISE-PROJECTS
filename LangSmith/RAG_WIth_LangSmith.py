...
# ----------------- helpers (traced) -----------------
# abh yeh langsmith inn function ko bhi trace karega...humne yahan pe decorators laga diye hai jiske karan abh yeh traceale func bann gaya hai
# i can also mention tags and meta data relevant to that func
...
# @traceable(name="build_vectorstore", tags={'embedding','vectorstore'}, metadata = {'embedding-model':'text-embedding'})
